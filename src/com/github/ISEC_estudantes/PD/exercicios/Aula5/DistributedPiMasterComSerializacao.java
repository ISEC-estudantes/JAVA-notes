...
public class DistributedPiMasterComSerializacao {
        ...
        try {
            ...
            while ((workerCoord = inFile.readLine()) != null) {
                ...
                try {
                    ...
                    workers.add(new Socket(workerName, workerPort));
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        if (args.length != 2) {
            System.out.println("Sintaxe: java ParallelPi <numero de intervalos> <ficheiro com os ips e portos de escuta dos workers>");
            return;
        }
        ...
        try {
            ...
            for (i = 0; i < nWorkers; ++i) {
                ...
                output.flush();
//                nao se mete o close porque ja se esta a fechar as coisas no finally
//                output.close();
            }
