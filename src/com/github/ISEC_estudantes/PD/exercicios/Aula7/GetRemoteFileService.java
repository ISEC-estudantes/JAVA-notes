 ...
 * @author Jose'
 */
public class GetRemoteFileService
{
    ...
    public GetRemoteFileService(File localDirectory)
    {
    ...
    public byte [] getFileChunk(String fileName, long offset)
    {
        ...
        try{
            ...
            if(nbytes < fileChunck.length){
               ...
               /*
                * Copia os bytes obitos do ficheiro de fileChunck para aux        
                */         
    ...
    static public void main(String []args)
    {
        ...
        */
        try{
             ...
             * Cria o servico
             */            
            GetRemoteFileService timeService = //...
