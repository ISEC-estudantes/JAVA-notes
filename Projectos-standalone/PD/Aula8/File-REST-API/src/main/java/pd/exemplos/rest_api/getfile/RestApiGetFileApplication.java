package pd.exemplos.rest_api.getfile;
...
import pd.exemplos.rest_api.getfile.security.AuthorizationFilter;


//buscar as classes para associar
@ComponentScan(basePackages = {"pd.exemplos.rest_api.getfile.controllers"})
